...
module.exports = {
    ...
    getWCTaxYTD: async (year, wc_total, previ_payDate_year, current_payDate_year, pre_stub_wc_ytd_total,state, month, tdiff, paymentTotal, duration, total_hours, tytd) => { // paymentTotal, duration, total_hours, tytd
		var wc = paystubConfig[year].wc;
		var wc_ytd_total = 0;
		var diff = 0;
		if (typeof(wc[state]) !== 'undefined' && wc[state] !== "") {
